...
final class ClassMemberQuery
{
    ...
    {
        return new self($this->class, $this->memberName, self::TYPE_CONSTANT);
    }
    public function onlyMethods() : self
    {
        return new self($this->class, $this->memberName, self::TYPE_METHOD);
    }
    public function onlyProperties() : self
    {
        return new self($this->class, $this->memberName, self::TYPE_PROPERTY);
    }
    /**
