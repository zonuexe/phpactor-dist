...
$foobar->barbar($foo, $<>
EOT
, [['type' => Suggestion::TYPE_VARIABLE, 'name' => '$foobar', 'short_description' => 'Foobar => param #2 Foobar $bar']]]);
...
EOT
, [['type' => Suggestion::TYPE_VARIABLE, 'name' => '$foobar', 'short_description' => 'Foobar => param #3 $mixed'], ['type' => Suggestion::TYPE_VARIABLE, 'name' => '$param', 'short_description' => '"string" => param #3 $mixed']]]);
...
EOT
, []]);
        (yield 'function parameter completion' => [<<<'EOT'
<?php
...
foobar($param, $<>);
EOT
, [['type' => Suggestion::TYPE_VARIABLE, 'name' => '$hello', 'short_description' => '"string" => param #2 string $barbar']]]);
        (yield 'function parameter completion, single parameters' => [<<<'EOT'
<?php
function foobar($bar, string $barbar) {}
...
foobar($<>);
EOT
, [['type' => Suggestion::TYPE_VARIABLE, 'name' => '$hello', 'short_description' => '"string" => param #1 $bar']]]);
        (yield 'does not use variables declared after offset a' => [<<<'EOT'
<?php
function foobar($bar, string $barbar) {}
...
EOT
, [['type' => Suggestion::TYPE_VARIABLE, 'name' => '$hello', 'short_description' => '"string" => param #1 $bar']]]);
        (yield 'does not use variables declared after offset with bracket' => [<<<'EOT'
<?php
function foobar($bar, string $barbar) {}
...
EOT
, [['type' => Suggestion::TYPE_VARIABLE, 'name' => '$hello', 'short_description' => '"string" => param #1 $bar'], ['type' => Suggestion::TYPE_VARIABLE, 'name' => '$this', 'short_description' => 'Hello => param #1 $bar']]]);
        (yield 'can complete methods declared after the offset' => [<<<'EOT'
<?php
class Hello
{
    public function goodbye()
...
EOT
, [['type' => Suggestion::TYPE_VARIABLE, 'name' => '$this', 'short_description' => 'Hello => param #1 $bar']]]);
...
, [['type' => Suggestion::TYPE_VARIABLE, 'name' => '$this', 'short_description' => 'Hello => param #1 $bar']]]);
    ...
    {
        (yield 'complete after comma' => [<<<'EOT'
<?php
function foobar($bar, string $barbar) {}
...
\class_alias('Phpactor202301\\Phpactor\\Completion\\Tests\\Integration\\Bridge\\TolerantParser\\WorseReflection\\WorseParameterCompletorTest', 'Phpactor\\Completion\\Tests\\Integration\\Bridge\\TolerantParser\\WorseReflection\\WorseParameterCompletorTest', \false);
