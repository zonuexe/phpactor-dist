...
class ConstantFormatterTest extends IntegrationTestCase
{
    ...
    {
        (yield 'string' => ['<?php namespace Bar {class Foobar {const BAR = "FOO";}}', 'BAR = "FOO"']);
        (yield 'int' => ['<?php namespace Bar {class Foobar {const BAR = 123;}}', 'BAR = 123']);
        (yield 'invalid' => ['<?php namespace Bar {class Foobar {const BAR}}', 'BAR = null']);
        (yield 'array' => ['<?php namespace Bar {class Foobar {const BAR=[123]}}', 'BAR = [123]']);
    }
}
\class_alias('Phpactor202301\\Phpactor\\Completion\\Tests\\Integration\\Bridge\\WorseReflection\\Formatter\\ConstantFormatterTest', 'Phpactor\\Completion\\Tests\\Integration\\Bridge\\WorseReflection\\Formatter\\ConstantFormatterTest', \false);
