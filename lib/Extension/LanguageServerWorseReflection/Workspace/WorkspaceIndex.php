...
class WorkspaceIndex
{
    ...
    public function __construct(private SourceCodeReflector $reflector, private int $updateInterval = 1000)
    {
    }
    ...
    public function update(TextDocumentUri $textDocumentUri, string $updatedText) : void
    {
        ...
        if ($textDocument === null) {
            throw new RuntimeException(\sprintf('Could not find document "%s"', $textDocumentUri->__toString()));
        }
