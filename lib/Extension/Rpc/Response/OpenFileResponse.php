...
class OpenFileResponse implements Response
{
    ...
    const VALID_TARGETS = [self::TARGET_FOCUSED_WINDOW, self::TARGET_VERTICAL_SPLIT, self::TARGET_HORIZONTAL_SPLIT, self::TARGET_NEW_TAB];
    ...
    {
        return ['path' => $this->path, 'offset' => $this->offset, 'force_reload' => $this->forceReload, 'target' => $this->target];
    }
