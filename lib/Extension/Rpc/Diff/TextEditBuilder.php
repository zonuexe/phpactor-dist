    ...
    public function calculateTextEdits(string $original, string $new)
    {
        ...
        foreach ($diff as $line) {
            ...
            switch ($line[1]) {
                ...
                // Added
                case 1:
                    $edits[] = ['start' => ['line' => $lineNumber, 'character' => 0], 'end' => ['line' => $lineNumber, 'character' => 0], 'text' => $token];
                    break;
                // Removed
                case 2:
                    $edits[] = ['start' => ['line' => $lineNumber, 'character' => 0], 'end' => ['line' => $lineNumber + 1, 'character' => 0], 'text' => ''];
                    $lineNumber--;
                    break;
            }
        }
