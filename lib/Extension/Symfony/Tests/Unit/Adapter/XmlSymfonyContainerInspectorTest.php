...
namespace Phpactor202301\Phpactor\Extension\Symfony\Tests\Unit\Adapter;
...
EOT
        ...
        self::assertEquals([new SymfonyContainerService('service_container', TypeFactory::class('Phpactor202301\\Symfony\\Component\\DependencyInjection\\ContainerInterface'))], $this->inspect($this->workspace()->path('services.xml'))->services());
    }
...
EOT
        ...
        self::assertEquals([new SymfonyContainerService('one', TypeFactory::class('One'))], $this->inspect($this->workspace()->path('services.xml'))->services());
    }
...
EOT
        ...
        self::assertEquals(new SymfonyContainerService('service_container', TypeFactory::class('Phpactor202301\\Symfony\\Component\\DependencyInjection\\ContainerInterface')), $this->inspect($this->workspace()->path('services.xml'))->service('service_container'));
    }
...
EOT
        ...
        self::assertEquals([new SymfonyContainerParameter('kernel.project_dir', new StringLiteralType('/app')), new SymfonyContainerParameter('kernel.environment', new StringLiteralType('dev'))], $this->inspect($this->workspace()->path('services.xml'))->parameters());
    }
...
EOT
        ...
        \touch($this->workspace()->path('services.xml'), 100);
...
EOT
        ...
        \touch($this->workspace()->path('services.xml'), 101);
...
\class_alias('Phpactor202301\\Phpactor\\Extension\\Symfony\\Tests\\Unit\\Adapter\\XmlSymfonyContainerInspectorTest', 'Phpactor\\Extension\\Symfony\\Tests\\Unit\\Adapter\\XmlSymfonyContainerInspectorTest', \false);
