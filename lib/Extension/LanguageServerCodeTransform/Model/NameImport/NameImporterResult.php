...
{
    private function __construct(private bool $success, private ?NameImport $nameImport, private ?array $textEdits, private ?Throwable $error)
    {
    }
    ...
    {
        return $this->isSuccess() === \true && $this->getNameImport() !== null && $this->getNameImport()->alias() !== null;
    }
