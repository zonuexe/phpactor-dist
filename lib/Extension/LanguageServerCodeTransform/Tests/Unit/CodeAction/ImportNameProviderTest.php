...
class ImportNameProviderTest extends IntegrationTestCase
{
    ...
    public function testImportProvider(string $manifest, Closure $assertion, bool $imprtGlobals = \false) : void
    {
        ...
        $tester = $this->container([WorseReflectionExtension::PARAM_IMPORT_GLOBALS => $imprtGlobals, LanguageServerCodeTransformExtension::PARAM_REPORT_NON_EXISTING_NAMES => \true])->get(LanguageServerBuilder::class)->tester(ProtocolFactory::initializeParams($this->workspace()->path()));
        $tester->initialize();
    ...
    public function provideImportProvider() : Generator
    {
        ...
        //, 1, 1
        //];
        (yield 'code actions + diagnostic for non-existant class' => [<<<'EOT'
// File: subject.php
...
, function (array $codeActions, array $diagnostics) : void {
        ...
        (yield 'code actions + diagnostic for namespaced non-existant class' => [<<<'EOT'
// File: subject.php
...
, function (array $codeActions, array $diagnostics) : void {
        ...
        (yield 'code action and diagnostic for missing global class name' => [<<<'EOT'
// File: subject.php
...
, function (array $codeActions, array $diagnostics) : void {
        ...
        (yield 'no code action or diagnostics for missing global function name' => [<<<'EOT'
// File: subject.php
...
, function (array $codeActions, array $diagnostics) : void {
        ...
        (yield 'no diagnostics for class declared in same namespace' => [<<<'EOT'
// File: subject.php
<?php
...
, function (array $codeActions, array $diagnostics) : void {
        ...
        (yield 'built in global funtion' => [<<<'EOT'
// File: subject.php
<?php
...
, function (array $codeActions, array $diagnostics) : void {
        ...
        (yield 'built in global function with import globals' => [<<<'EOT'
// File: functions.php
// File: subject.php
<?php
...
\class_alias('Phpactor202301\\Phpactor\\Extension\\LanguageServerCodeTransform\\Tests\\Unit\\CodeAction\\ImportNameProviderTest', 'Phpactor\\Extension\\LanguageServerCodeTransform\\Tests\\Unit\\CodeAction\\ImportNameProviderTest', \false);
