...
class GenerateConstructorProvider implements CodeActionProvider
{
    ...
    public function provideActionsFor(TextDocumentItem $textDocument, Range $range, CancellationToken $cancel) : Promise
    {
        ...
        return new Success([new CodeAction(title: 'Generate constructor', kind: self::KIND, diagnostics: [], isPreferred: \false, edit: $this->converter->toLspWorkspaceEdit($edits))]);
    }
