...
, $schema);
    ...
    private function createExtension1() : Extension
    {
        return new class implements Extension
        {
            ...
            {
                $resolver->setDefaults(['bar.foo' => 1234, 'foo.bar' => 'bar', 'bloob' => \false]);
                $resolver->setRequired(['bar.foo']);
                $resolver->setTypes(['bar.foo' => 'string', 'foo.bar' => 'string', 'bloob' => 'bool']);
                $resolver->setDescriptions(['bar.foo' => 'This does something', 'bloob' => 'Testing boolean defaults']);
                $resolver->setEnums(['bar.foo' => ['one', 'two']]);
            }
...
\class_alias('Phpactor202301\\Phpactor\\Extension\\Core\\Tests\\Unit\\Model\\JsonSchemaBuilderTest', 'Phpactor\\Extension\\Core\\Tests\\Unit\\Model\\JsonSchemaBuilderTest', \false);
