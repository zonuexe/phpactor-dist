...
class ClassCopyCommand extends Command
{
    ...
    public function __construct(private ClassCopy $copier, private Prompt $prompt)
    {
        parent::__construct();
    }
    public function configure() : void
    {
        ...
        $this->addOption('type', null, InputOption::VALUE_REQUIRED, \sprintf('Type of copy: "%s"', \implode('", "', [self::TYPE_AUTO, self::TYPE_CLASS, self::TYPE_FILE])), self::TYPE_AUTO);
    }
