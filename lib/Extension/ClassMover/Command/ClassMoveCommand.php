...
class ClassMoveCommand extends Command
{
    ...
    public function __construct(private ClassMover $mover, private Prompt $prompt)
    {
        parent::__construct();
    }
    public function configure() : void
    {
        ...
        $this->addOption('type', null, InputOption::VALUE_REQUIRED, \sprintf('Type of move: "%s"', \implode('", "', [self::TYPE_AUTO, self::TYPE_CLASS, self::TYPE_FILE])), self::TYPE_AUTO);
