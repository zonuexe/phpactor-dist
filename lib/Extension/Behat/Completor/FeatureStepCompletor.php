...
class FeatureStepCompletor implements Completor
{
    ...
    public function __construct(private StepGenerator $generator, private StepParser $parser, StepScorer $stepSorter = null)
    {
    ...
    public function complete(TextDocument $source, ByteOffset $byteOffset) : Generator
    {
        ...
        foreach ($steps as $step) {
            ...
            (yield Suggestion::createWithOptions($suggestion, ['label' => $step->pattern(), 'short_description' => $step->context()->class(), 'type' => Suggestion::TYPE_SNIPPET, 'range' => Range::fromStartAndEnd($startOffset, $startOffset + \strlen($partial))]));
        }
        return \false;
    }
