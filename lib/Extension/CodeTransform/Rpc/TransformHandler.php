...
class TransformHandler implements Handler
{
    ...
    {
        $resolver->setDefaults([self::PARAM_NAME => null]);
    ...
    public function handle(array $arguments)
    {
        ...
        $transformedCode = $this->codeTransform->transform($code, [$arguments[self::PARAM_NAME]]);
        return UpdateFileSourceResponse::fromPathOldAndNewSource($arguments[self::PARAM_PATH], $arguments[self::PARAM_SOURCE], (string) $transformedCode);
    }
