...
namespace Phpactor202301\Phpactor\WorseReflection\Tests\Inference;
...
class SelfTest extends IntegrationTestCase
{
    ...
    public function provideSelf() : Generator
    {
        foreach ((array) \glob(__DIR__ . '/*/*.test') as $fname) {
            ...
            (yield $dirName . ' ' . \basename((string) $fname) => [$fname]);
        }
    }
}
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Tests\\Inference\\SelfTest', 'Phpactor\\WorseReflection\\Tests\\Inference\\SelfTest', \false);
