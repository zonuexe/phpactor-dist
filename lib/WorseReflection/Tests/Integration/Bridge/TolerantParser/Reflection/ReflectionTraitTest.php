...
class ReflectionTraitTest extends IntegrationTestCase
{
    ...
    {
        return ['It reflects a trait' => [<<<'EOT'
<?php
...
, 'Barfoo', function ($class) : void {
        ...
        }], 'It reflects a classes traits' => [<<<'EOT'
<?php
...
EOT
, 'Int1', function (ReflectionTrait $class) : void {
...
EOT
, 'Class1', function (ReflectionTrait $class) : void {
...
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Tests\\Integration\\Bridge\\TolerantParser\\Reflection\\ReflectionTraitTest', 'Phpactor\\WorseReflection\\Tests\\Integration\\Bridge\\TolerantParser\\Reflection\\ReflectionTraitTest', \false);
