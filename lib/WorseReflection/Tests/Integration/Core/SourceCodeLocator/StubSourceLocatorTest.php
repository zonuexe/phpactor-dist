...
namespace Phpactor202301\Phpactor\WorseReflection\Tests\Integration\Core\SourceCodeLocator;
...
class StubSourceLocatorTest extends IntegrationTestCase
{
    ...
    public function setUp() : void
    {
        ...
        $this->sourceLocator = new StubSourceLocator($reflector, $this->workspace()->path('stubs'), $this->workspace()->path('cache'));
    }
...
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Tests\\Integration\\Core\\SourceCodeLocator\\StubSourceLocatorTest', 'Phpactor\\WorseReflection\\Tests\\Integration\\Core\\SourceCodeLocator\\StubSourceLocatorTest', \false);
