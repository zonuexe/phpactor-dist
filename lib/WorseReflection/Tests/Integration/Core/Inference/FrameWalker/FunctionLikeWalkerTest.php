...
, function (Frame $frame) : void {
            ...
            $this->assertEquals('Phpactor202301\\Foobar\\Barfoo\\Foobar', $frame->locals()->byName('this')->first()->type()->__toString());
            $this->assertEquals(\false, $frame->locals()->byName('this')->first()->isProperty());
        }]);
        (yield 'It returns method arguments' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'It injects method argument with inferred types' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
            ...
            $this->assertEquals('Phpactor202301\\Foobar\\Barfoo\\World', (string) $type->iterableValueType());
        }]);
        (yield 'Variadic argument' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'Respects closure scope' => [<<<'EOT'
<?php
$foo = 'bar';
...
, function (Frame $frame) : void {
        ...
        (yield 'Static anonymous function has no $this or self::' => [<<<'EOT'
<?php
$foo = 'bar';
...
, function (Frame $frame) : void {
        ...
        (yield 'Injects closure parameters' => [<<<'EOT'
<?php
$foo = 'bar';
...
, function (Frame $frame) : void {
        ...
        (yield 'Injects imported closure parent scope variables' => [<<<'EOT'
<?php
$zed = 'zed';
$art = 'art';
...
, function (Frame $frame) : void {
        ...
        (yield 'Injects variables with @var (non-standard)' => [<<<'EOT'
<?php
/** @var string $zed */
$zed;
<>
...
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Tests\\Integration\\Core\\Inference\\FrameWalker\\FunctionLikeWalkerTest', 'Phpactor\\WorseReflection\\Tests\\Integration\\Core\\Inference\\FrameWalker\\FunctionLikeWalkerTest', \false);
