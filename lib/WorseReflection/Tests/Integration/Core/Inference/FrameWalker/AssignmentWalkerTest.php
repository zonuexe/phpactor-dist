...
class AssignmentWalkerTest extends FrameWalkerTestCase
{
    ...
    {
        (yield 'It registers string assignments' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'It returns types for reassigned variables' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'It returns type for $this' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'It tracks assigned properties' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'It assigns property values to assignments' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'It tracks assigned array properties' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'It tracks assigned from variable' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'Handles array assignments' => [<<<'EOT'
<?php
$foo = [ 'foo' => 'bar' ];
$bar = $foo['foo'];
<>
...
, function (Frame $frame) : void {
        ...
        (yield 'Includes list assignments' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'From generic return type with docblock' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
            ...
            $this->assertEquals('Foobar\\Listy<Foobar\\Collection>', (string) $frame->locals()->byName('bar')->first()->type());
            $type = $frame->locals()->byName('bar')->first()->type();
            $this->assertEquals('Phpactor202301\\Foobar\\Collection', $type->iterableValueType()->__toString());
        }]);
        (yield 'From incomplete assignment' => [<<<'EOT'
<?php
...
, function (Frame $frame) : void {
        ...
        (yield 'References previously walked member' => [<<<'EOT'
<?php
...
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Tests\\Integration\\Core\\Inference\\FrameWalker\\AssignmentWalkerTest', 'Phpactor\\WorseReflection\\Tests\\Integration\\Core\\Inference\\FrameWalker\\AssignmentWalkerTest', \false);
