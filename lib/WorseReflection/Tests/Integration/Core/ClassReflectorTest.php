...
class ClassReflectorTest extends IntegrationTestCase
{
    ...
    {
        return ['Class' => ['<?php class Foobar {}', 'Foobar', 'reflectClass', ReflectionClass::class], 'Interface' => ['<?php interface Foobar {}', 'Foobar', 'reflectInterface', ReflectionInterface::class], 'Trait' => ['<?php trait Foobar {}', 'Foobar', 'reflectTrait', ReflectionTrait::class]];
    }
    /**
...
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Tests\\Integration\\Core\\ClassReflectorTest', 'Phpactor\\WorseReflection\\Tests\\Integration\\Core\\ClassReflectorTest', \false);
