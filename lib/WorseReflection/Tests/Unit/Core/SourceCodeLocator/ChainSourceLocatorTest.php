...
class ChainSourceLocatorTest extends TestCase
{
    ...
    {
        $this->expectException(\Phpactor202301\Phpactor\WorseReflection\Core\Exception\SourceNotFound::class);
    ...
    public function testDelegateToFirst() : void
    {
        ...
        $source = $this->locate([$this->locator1->reveal(), $this->locator2->reveal()], $class);
    ...
    public function testAllFail() : void
    {
        ...
        $this->locate([$this->locator1->reveal(), $this->locator2->reveal()], $class);
    }
...
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Tests\\Unit\\Core\\SourceCodeLocator\\ChainSourceLocatorTest', 'Phpactor\\WorseReflection\\Tests\\Unit\\Core\\SourceCodeLocator\\ChainSourceLocatorTest', \false);
