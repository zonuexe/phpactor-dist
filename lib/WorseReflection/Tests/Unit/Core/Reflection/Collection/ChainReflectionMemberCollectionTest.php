...
class ChainReflectionMemberCollectionTest extends TestCase
{
    ...
    {
        $collection = ChainReflectionMemberCollection::fromCollections([$this->collection1->reveal(), $this->collection2->reveal()]);
    ...
    {
        $collection1 = ChainReflectionMemberCollection::fromCollections([$this->collection1->reveal()]);
    ...
    {
        $collection1 = ChainReflectionMemberCollection::fromCollections([$this->collection1->reveal(), $this->collection2->reveal()]);
        $this->collection1->count()->willReturn(1);
        $this->collection2->count()->willReturn(3);
        $this->collection1->get('foobar')->willReturn($this->member1->reveal());
        $this->collection1->has('foobar')->willReturn(\true);
    ...
    {
        $collection1 = ChainReflectionMemberCollection::fromCollections([$this->collection1->reveal(), $this->collection2->reveal()]);
        $this->collection1->has('foo')->willReturn(\true);
    ...
    public function testReturnBelongingTo() : void
    {
        ...
        $this->assertEquals(ChainReflectionMemberCollection::fromCollections([$this->collection3->reveal(), $this->collection4->reveal()]), $collection1->belongingTo($className));
    }
    public function testReturnsItemsAtOffset() : void
    {
        ...
        $this->assertEquals(ChainReflectionMemberCollection::fromCollections([$this->collection3->reveal(), $this->collection4->reveal()]), $collection1->atOffset($name));
    }
    public function testReturnsMembersByName() : void
    {
        ...
        $this->assertEquals(ChainReflectionMemberCollection::fromCollections([$this->collection3->reveal(), $this->collection4->reveal()]), $collection1->byName($name));
    }
}
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Tests\\Unit\\Core\\Reflection\\Collection\\ChainReflectionMemberCollectionTest', 'Phpactor\\WorseReflection\\Tests\\Unit\\Core\\Reflection\\Collection\\ChainReflectionMemberCollectionTest', \false);
