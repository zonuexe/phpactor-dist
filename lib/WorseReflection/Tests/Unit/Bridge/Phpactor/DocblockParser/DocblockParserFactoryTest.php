...
namespace Phpactor202301\Phpactor\WorseReflection\Tests\Unit\Bridge\Phpactor\DocblockParser;
...
use Phpactor202301\Phpactor\WorseReflection\Core\Type\ConditionalType;
...
use Phpactor202301\Phpactor\WorseReflection\Core\Type\IntMaxType;
...
class DocblockParserFactoryTest extends IntegrationTestCase
{
    ...
    {
        (yield ['/** @return string */', new StringType()]);
        (yield ['/** @return int */', new IntType()]);
        (yield ['/** @return float */', new FloatType()]);
        (yield ['/** @return mixed */', new MixedType()]);
        (yield ['/** @return array */', new ArrayType(new MissingType())]);
        (yield ['/** @return array|string */', new UnionType(new ArrayType(new MissingType()), new StringType())]);
        (yield ['/** @return array&string */', new IntersectionType(new ArrayType(new MissingType()), new StringType())]);
        (yield ['/** @return array<string> */', new ArrayType(new StringType())]);
        (yield ['/** @return bool */', new BooleanType()]);
        (yield ['/** @return null */', new NullType()]);
        (yield ['/** @return callable */', new CallableType([], new MissingType())]);
        (yield ['/** @return callable(): string */', new CallableType([], new StringType())]);
        (yield ['/** @return callable(string,bool): string */', new CallableType([new StringType(), new BooleanType()], new StringType())]);
        (yield ['/** @return iterable */', new PseudoIterableType()]);
        (yield ['/** @return object */', new ObjectType()]);
        (yield ['/** @return resource */', new ResourceType()]);
        (yield ['/** @return void */', new VoidType()]);
        (yield ['/** @return array<int, string> */', new ArrayType(new IntType(), new StringType())]);
        (yield ['/** @return array<int, array<string,bool>> */', new ArrayType(new IntType(), new ArrayType(new StringType(), new BooleanType()))]);
        (yield 'nullable' => ['/** @return ?string */', '?string']);
        (yield ['/** @return T */', 'T']);
        (yield ['/** @return \\IteratorAggregate<Foobar> */', 'IteratorAggregate<Foobar>']);
        (yield ['/** @return array{} */', 'array{}']);
        (yield 'arrayshape with keys' => ['/** @return array{foo:int,bar:string} */', 'array{foo:int,bar:string}']);
        (yield 'parenthesized' => ['/** @return null|(callable(int):string)|string|int */', 'null|(callable(int): string)|string|int']);
        (yield 'multiline array shape' => [<<<'EOT'
/**
 * @return array{
 *   foo:int,
 *   bar:string
...
, 'array{foo:int,bar:string}']);
        (yield 'literals' => ['/** @return null|"foo"|123|123.3 */', 'null|"foo"|123|123.3']);
        (yield 'list' => ['/** @return list */', TypeFactory::list()]);
        (yield 'list with type' => ['/** @return list<string> */', TypeFactory::list(TypeFactory::string())]);
        (yield 'never' => ['/** @return never */', TypeFactory::never()]);
        (yield 'false' => ['/** @return false */', TypeFactory::false()]);
        (yield 'union false' => ['/** @return false|int */', TypeFactory::union(TypeFactory::false(), TypeFactory::int())]);
        (yield 'psalm prefix' => ['/** @psalm-return int */', TypeFactory::int()]);
        (yield 'conditional type' => ['/** @return ($foo is true ? string : int) */', TypeFactory::parenthesized(new ConditionalType('$foo', TypeFactory::boolLiteral(\true), TypeFactory::string(), TypeFactory::int()))]);
        (yield 'class string generic' => ['/** @return class-string<T> */', TypeFactory::classString('T')]);
        (yield 'int range max' => ['/** @return int<12, max> */', TypeFactory::intRange(new IntLiteralType(12), new IntMaxType(\PHP_INT_MAX))]);
        (yield 'int range' => ['/** @return int<12, 23> */', TypeFactory::intRange(new IntLiteralType(12), new IntLiteralType(23))]);
        (yield 'int positive' => ['/** @return positive-int */', TypeFactory::intPositive()]);
        (yield 'int negative' => ['/** @return negative-int */', TypeFactory::intNegative()]);
    }
...
EOT;
    ...
    public function testMethods() : void
    {
        ...
        $methods = $docblock->methods($reflector->reflectClass('Phpactor202301\\Bar\\Foobar'));
    ...
    public function testProperties() : void
    {
        ...
        $methods = $docblock->properties($reflector->reflectClass('Phpactor202301\\Bar\\Foobar'));
        self::assertEquals('foobar', $methods->first()->name());
...
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Tests\\Unit\\Bridge\\Phpactor\\DocblockParser\\DocblockParserFactoryTest', 'Phpactor\\WorseReflection\\Tests\\Unit\\Bridge\\Phpactor\\DocblockParser\\DocblockParserFactoryTest', \false);
