...
class TypeFactory
{
    ...
    {
        return new UnionType(new IntLiteralType(0), new FloatLiteralType(0.0), new StringLiteralType(''), new StringLiteralType('0'), new ArrayLiteral([]), new BooleanLiteralType(\false), new NullType());
    }
    /**
     * @param mixed[] $values
     * @return Type[]
