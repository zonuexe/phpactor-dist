...
class TemporarySourceLocator implements SourceCodeLocator
{
    ...
    public function __construct(private SourceCodeReflector $reflector, private bool $locateFunctions = \false)
    {
    }
    ...
    {
        if (null === $this->source) {
            throw new SourceNotFound(\sprintf('No source in temporary source locator yet'));
        }
 ...
 * path for all source code.
 */
\class_alias('Phpactor202301\\Phpactor\\WorseReflection\\Core\\SourceCodeLocator\\TemporarySourceLocator', 'Phpactor\\WorseReflection\\Core\\SourceCodeLocator\\TemporarySourceLocator', \false);
