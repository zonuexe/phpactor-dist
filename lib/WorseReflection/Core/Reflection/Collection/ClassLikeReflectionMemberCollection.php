...
final class ClassLikeReflectionMemberCollection extends \Phpactor\WorseReflection\Core\Reflection\Collection\AbstractReflectionCollection implements \Phpactor\WorseReflection\Core\Reflection\Collection\ReflectionMemberCollection
{
    ...
    public static function fromClassMemberDeclarations(ServiceLocator $serviceLocator, ClassDeclaration $class, ReflectionClass $reflectionClass) : self
    {
        return self::fromDeclarations($serviceLocator, $reflectionClass, $class->classMembers->classMemberDeclarations);
    }
    ...
    {
        return self::fromDeclarations($serviceLocator, $reflectionTrait, $traitDeclaration->traitMembers->traitMemberDeclarations);
    }
    ...
    {
        return self::fromDeclarations($serviceLocator, $reflectionInterface, $interfaceDeclaration->interfaceMembers->interfaceMemberDeclarations);
    }
    ...
    {
        return self::fromDeclarations($serviceLocator, $reflectionEnum, $enumDeclaration->enumMembers->enumMemberDeclarations);
    }
