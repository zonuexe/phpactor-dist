...
class ReflectionDeclaredConstantCollection extends \Phpactor\WorseReflection\Core\Reflection\Collection\AbstractReflectionCollection
{
    ...
    public static function fromNode(ServiceLocator $serviceLocator, TextDocument $sourceCode, SourceFileNode $node) : \Phpactor\WorseReflection\Core\Reflection\Collection\ReflectionDeclaredConstantCollection
    {
        $items = [];
