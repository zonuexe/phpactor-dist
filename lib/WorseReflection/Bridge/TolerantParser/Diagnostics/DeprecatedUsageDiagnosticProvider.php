...
class DeprecatedUsageDiagnosticProvider implements DiagnosticProvider
{
    ...
    {
        (yield new DiagnosticExample(title: 'deprecated class', source: <<<'PHP'
<?php
...
, valid: \false, assertion: function (Diagnostics $diagnostics) : void {
        ...
        (yield new DiagnosticExample(title: 'deprecated constant', source: <<<'PHP'
<?php
...
, valid: \false, assertion: function (Diagnostics $diagnostics) : void {
        ...
        (yield new DiagnosticExample(title: 'deprecated enum', source: <<<'PHP'
<?php
...
new NotDeprecated();
PHP
, valid: \false, minPhpVersion: '8.1', assertion: function (Diagnostics $diagnostics) : void {
            Assert::assertCount(2, $diagnostics);
            Assert::assertEquals('Call to deprecated enum "Deprecated"', $diagnostics->at(0)->message());
        }));
        (yield new DiagnosticExample(title: 'deprecated function', source: <<<'PHP'
<?php
...
, valid: \false, assertion: function (Diagnostics $diagnostics) : void {
        ...
        (yield new DiagnosticExample(title: 'deprecated method', source: <<<'PHP'
<?php
...
, valid: \false, assertion: function (Diagnostics $diagnostics) : void {
        ...
        (yield new DiagnosticExample(title: 'deprecated on trait', source: <<<'PHP'
<?php
...
, valid: \false, assertion: function (Diagnostics $diagnostics) : void {
        ...
        (yield new DiagnosticExample(title: 'deprecated on property', source: <<<'PHP'
<?php
...
, valid: \false, assertion: function (Diagnostics $diagnostics) : void {
    ...
    private function memberAccessDiagnostics(MemberAccessContext $resolved) : Generator
    {
        ...
        (yield new \Phpactor\WorseReflection\Bridge\TolerantParser\Diagnostics\DeprecatedUsageDiagnostic($resolved->memberNameRange(), $member->name(), $member->deprecation()->message(), $member->memberType()));
    }
    /**
     * @return Generator<DeprecatedUsageDiagnostic>
     */
    private function classLikeDiagnostics(ClassLikeContext $resolved) : Generator
    {
        ...
        (yield new \Phpactor\WorseReflection\Bridge\TolerantParser\Diagnostics\DeprecatedUsageDiagnostic($resolved->range(), $reflectionClass->name(), $reflectionClass->deprecation()->message(), $reflectionClass->classLikeType()));
    }
    /**
     * @return Generator<DeprecatedUsageDiagnostic>
     */
    private function functionDiagnostics(FunctionCallContext $resolved) : Generator
    {
        ...
        (yield new \Phpactor\WorseReflection\Bridge\TolerantParser\Diagnostics\DeprecatedUsageDiagnostic($resolved->range(), $reflectionFunction->name(), $reflectionFunction->docblock()->deprecation()->message(), 'function'));
    }
}
