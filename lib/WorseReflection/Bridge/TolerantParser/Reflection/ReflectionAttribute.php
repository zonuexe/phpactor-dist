...
class ReflectionAttribute implements PhpactorReflectionObjectCreationExpression, \Phpactor\WorseReflection\Bridge\TolerantParser\Reflection\ClassInvocation
{
    public function __construct(private ServiceLocator $locator, private Frame $frame, private Attribute $node)
    {
    }
