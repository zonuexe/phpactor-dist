...
class IndexedReferenceFinder implements ReferenceFinder
{
    ...
    public function __construct(private QueryClient $query, private Reflector $reflector, ?ContainerTypeResolver $containerTypeResolver = null, private bool $deepReferences = \true)
    {
    ...
    private function symbolTypeToMemberType(NodeContext $nodeContext) : string
    {
        ...
        throw new RuntimeException(\sprintf('Could not convert symbol type "%s" to member type', $symbolType));
    }
    /**
