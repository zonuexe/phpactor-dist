...
namespace Phpactor202301\Phpactor\Indexer\Tests\Adapter\ReferenceFinder;
...
class IndexedImplementationFinderTest extends IntegrationTestCase
{
    ...
    public function testFinder(string $manifest, int $expectedLocationCount) : void
    {
        ...
        $implementationFinder = new IndexedImplementationFinder($this->indexQuery($index), $this->createReflector());
        $locations = $implementationFinder->findImplementations(TextDocumentBuilder::create($source)->build(), ByteOffset::fromInt((int) $offset));
    ...
    {
        (yield 'interface implementations' => [<<<'EOT'
...
EOT
, 2]);
        (yield 'class implementations' => [<<<'EOT'
// File: project/subject.php
<?php class Fo<>o {}
// File: project/class.php
<?php
...
EOT
, 2]);
        (yield 'abstract class implementations' => [<<<'EOT'
// File: project/subject.php
...
EOT
, 2]);
        (yield 'implementations of abstract class implementation' => [<<<'EOT'
// File: project/subject.php
<?php abstract class Fo<>o {}
// File: project/class.php
<?php
...
EOT
, 2]);
        (yield 'does not count abstract class member' => [<<<'EOT'
// File: project/subject.php
...
EOT
, 1]);
        (yield 'member implementations of abstract class implementation' => [<<<'EOT'
// File: project/subject.php
<?php $foo = new Foo();
   $foo->d<>oThis();
}
...
\class_alias('Phpactor202301\\Phpactor\\Indexer\\Tests\\Adapter\\ReferenceFinder\\IndexedImplementationFinderTest', 'Phpactor\\Indexer\\Tests\\Adapter\\ReferenceFinder\\IndexedImplementationFinderTest', \false);
