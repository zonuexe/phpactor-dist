...
namespace Phpactor202301\Phpactor\CodeBuilder\Tests\Adapter\WorseReflection;
...
class WorseBuilderFactoryTest extends TestCase
{
    ...
    public function testClassWithPropertyImportedType() : void
    {
        ...
        $this->assertEquals('Foobar', $source->classes()->first()->properties()->first()->type()->__toString());
        $this->assertEquals('Phpactor202301\\Bar\\Foobar', (string) $source->useStatements()->first());
    }
    ...
    public function testMethodWithNullableReturnType() : void
    {
        ...
        $this->assertEquals('?string', $source->classes()->first()->methods()->first()->returnType()->__toString());
    }
...
\class_alias('Phpactor202301\\Phpactor\\CodeBuilder\\Tests\\Adapter\\WorseReflection\\WorseBuilderFactoryTest', 'Phpactor\\CodeBuilder\\Tests\\Adapter\\WorseReflection\\WorseBuilderFactoryTest', \false);
