...
class MethodBuilder extends AbstractBuilder implements NamedBuilder
{
    ...
    public function build() : Method
    {
        ...
        return new Method($this->name, $this->visibility ?? Visibility::public(), Parameters::fromParameters(\array_map(function (ParameterBuilder $builder) {
...
\class_alias('Phpactor202301\\Phpactor\\CodeBuilder\\Domain\\Builder\\MethodBuilder', 'Phpactor\\CodeBuilder\\Domain\\Builder\\MethodBuilder', \false);
