...
final class SimpleFileListProvider implements FileListProvider
{
    ...
    {
        return FileList::fromIterator($this->createFileIterator((string) $this->path));
    }
    private function createFileIterator(string $path) : Iterator
    {
        ...
        $files = new RecursiveIteratorIterator($files, RecursiveIteratorIterator::LEAVES_ONLY, RecursiveIteratorIterator::CATCH_GET_CHILD);
        return $files;
    }
}
