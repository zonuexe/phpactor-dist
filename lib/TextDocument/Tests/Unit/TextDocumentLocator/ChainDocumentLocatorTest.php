...
namespace Phpactor202301\Phpactor\TextDocument\Tests\Unit\TextDocumentLocator;
...
class ChainDocumentLocatorTest extends TestCase
{
    ...
    public function testReturnsTextDocument() : void
    {
        ...
        self::assertSame($document, $this->createWorkspace([InMemoryDocumentLocator::fromTextDocuments([$document])])->get(TextDocumentUri::fromString('file:///path/to/foo')));
    }
    public function testReturnsTextDocumentFromFirstWorkspace() : void
    {
        ...
        self::assertSame($document1, $this->createWorkspace([InMemoryDocumentLocator::fromTextDocuments([$document1]), InMemoryDocumentLocator::fromTextDocuments([$document2])])->get(TextDocumentUri::fromString('file:///path/to/foo')));
    }
    /**
...
\class_alias('Phpactor202301\\Phpactor\\TextDocument\\Tests\\Unit\\TextDocumentLocator\\ChainDocumentLocatorTest', 'Phpactor\\TextDocument\\Tests\\Unit\\TextDocumentLocator\\ChainDocumentLocatorTest', \false);
