...
class LineColTest extends TestCase
{
    ...
    {
        (yield ['', new LineCol(1, 1), 0]);
        (yield ['a', new LineCol(1, 1), 0]);
        (yield 'new line' => ["\na", new LineCol(2, 1), 1]);
        (yield 'multi-byte 1' => ['ᅑa', new LineCol(1, 2), 3, 'ᅑ']);
        (yield 'multi-byte 2' => ['ᅑacd', new LineCol(1, 3), 4, 'ᅑa']);
        (yield 'multi-byte 3' => ["ᅑ\nacd", new LineCol(2, 2), 5, "ᅑ\na"]);
    }
...
\class_alias('Phpactor202301\\Phpactor\\TextDocument\\Tests\\Unit\\LineColTest', 'Phpactor\\TextDocument\\Tests\\Unit\\LineColTest', \false);
