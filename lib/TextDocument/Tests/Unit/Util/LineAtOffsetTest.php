...
class LineAtOffsetTest extends TestCase
{
    ...
    {
        (yield ['hello thi<>s is', 'hello this is']);
        (yield 'first char' => ['h<>ello this is', 'hello this is']);
        (yield 'last char' => ['hello this is<>', 'hello this is']);
        (yield 'offset is newline' => ["hello this is\n<>", 'hello this is']);
        (yield [<<<'EOT'
<?php
...
\class_alias('Phpactor202301\\Phpactor\\TextDocument\\Tests\\Unit\\Util\\LineAtOffsetTest', 'Phpactor\\TextDocument\\Tests\\Unit\\Util\\LineAtOffsetTest', \false);
