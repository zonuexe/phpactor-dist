...
class LineColFromOffsetTest extends TestCase
{
     ...
     */
    public function testLineColFromOffset(string $document, int $offset, int $expectedLine, int $expectedCol) : void
    {
    ...
    {
        (yield 'hello 1' => ['hello', 0, 1, 1]);
        (yield 'hello 2' => ['hello', 2, 1, 3]);
        (yield 'multiline' => ["hello\ngoodbye", 8, 2, 3]);
        (yield 'multiline 2' => ["12\n345\n678", 4, 2, 2]);
        (yield '2 lines with special chars' => ["h转llo\ngoodbye", 10, 2, 3]);
        (yield '4 lines with special chars' => [<<<'EOT'
h转llo
goodbye
h转llo
goodbye
...
\class_alias('Phpactor202301\\Phpactor\\TextDocument\\Tests\\Unit\\Util\\LineColFromOffsetTest', 'Phpactor\\TextDocument\\Tests\\Unit\\Util\\LineColFromOffsetTest', \false);
