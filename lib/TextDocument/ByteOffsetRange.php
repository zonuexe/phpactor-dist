...
class ByteOffsetRange
{
    ...
    {
        return new self(ByteOffset::fromInt($start), ByteOffset::fromInt($end));
    }
...
\class_alias('Phpactor202301\\Phpactor\\TextDocument\\ByteOffsetRange', 'Phpactor\\TextDocument\\ByteOffsetRange', \false);
