...
class ChainDefinitionLocationProviderTest extends TestCase
{
    ...
    {
        $locator = new ChainDefinitionLocationProvider([$this->locator1->reveal(), $this->locator2->reveal()]);
    ...
    public function testExceptionWhenDefinitionNotFound() : void
    {
        ...
        $locator = new ChainDefinitionLocationProvider([$this->locator1->reveal()]);
    ...
    {
        return new TypeLocations([new TypeLocation(TypeFactory::unknown(), new DefinitionLocation(TextDocumentUri::fromString('/path/to.php'), ByteOffset::fromInt(1234)))]);
    }
}
\class_alias('Phpactor202301\\Phpactor\\ReferenceFinder\\Tests\\Unit\\ChainDefinitionLocationProviderTest', 'Phpactor\\ReferenceFinder\\Tests\\Unit\\ChainDefinitionLocationProviderTest', \false);
