...
namespace Phpactor202301\Phpactor\DocblockParser\Tests\Unit\Ast;
...
class NodeTest extends NodeTestCase
{
    ...
    {
        (yield ['@method static Baz\\Bar bar(string $boo, string $baz)', function (MethodTag $methodNode) : void {
    ...
    private function provideTags()
    {
        (yield ['@method static Baz\\Bar bar(string $boo, string $baz)', function (MethodTag $methodNode) : void {
            ...
            self::assertEquals('Phpactor202301\\Baz\\Bar', $methodNode->type->toString());
        ...
        (yield ['@property Baz\\Bar $foobar', function (PropertyTag $property) : void {
            self::assertEquals('$foobar', $property->name->toString());
        }]);
        (yield ['@deprecated This is deprecated']);
        (yield 'deprecated' => ['/** @deprecated This is deprecated */', function (Docblock $block) : void {
    ...
    {
        (yield 'scalar' => ['string']);
        (yield 'union' => ['@return string|int|bool|float|mixed', function (ReturnTag $return) : void {
            $type = $return->type;
        ...
        (yield 'list' => ['@return Foo[]', function (ReturnTag $return) : void {
            self::assertInstanceOf(ListBracketsNode::class, $return->type);
        }]);
        (yield 'generic' => ['@return Foo<Bar<string, int>, Baz|Bar>', function (ReturnTag $return) : void {
...
, $docblock->prose());
        ...
        (yield 'do not parse prose after first tag' => [<<<'EOT'
/**
...
, $docblock->prose());
        ...
        (yield 'parse open / closing HTML tags' => [<<<'EOT'
/**
 * Applies the callback to the elements of the given arrays
 * @link https://php.net/manual/en/function.array-map.php
...
\class_alias('Phpactor202301\\Phpactor\\DocblockParser\\Tests\\Unit\\Ast\\NodeTest', 'Phpactor\\DocblockParser\\Tests\\Unit\\Ast\\NodeTest', \false);
