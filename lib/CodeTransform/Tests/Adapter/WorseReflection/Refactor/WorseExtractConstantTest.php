...
class WorseExtractConstantTest extends WorseTestCase
{
    ...
    {
        return ['string' => ['extractConstant1.test', 'HELLO_WORLD'], 'numeric' => ['extractConstant2.test', 'HELLO_WORLD'], 'array_key' => ['extractConstant3.test', 'HELLO_WORLD'], 'namespaced' => ['extractConstant4.test', 'HELLO_WORLD'], 'replace all' => ['extractConstant5.test', 'HELLO_WORLD'], 'replace all numeric' => ['extractConstant6.test', 'HOUR'], 'replace heredoc' => ['extractConstant7.test', 'HELLO_WORLD']];
    }
...
\class_alias('Phpactor202301\\Phpactor\\CodeTransform\\Tests\\Adapter\\WorseReflection\\Refactor\\WorseExtractConstantTest', 'Phpactor\\CodeTransform\\Tests\\Adapter\\WorseReflection\\Refactor\\WorseExtractConstantTest', \false);
