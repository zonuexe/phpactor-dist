...
class WorseGenerateMethodTest extends WorseTestCase
{
    ...
    {
        return ['string' => ['generateMethod1.test'], 'parameter' => ['generateMethod2.test'], 'typed parameter' => ['generateMethod3.test'], 'undeclared parameter' => ['generateMethod4.test'], 'expression' => ['generateMethod5.test'], 'public accessor in another class' => ['generateMethod6.test'], 'public accessor on interface' => ['generateMethod7.test'], 'public accessor on interface with namespace' => ['generateMethod8.test'], 'imports classes' => ['generateMethod9.test'], 'static private method' => ['generateMethod10.test'], 'static public method' => ['generateMethod11.test'], 'add return type' => ['generateMethod12.test'], 'add return type with docblock' => ['generateMethod13.test'], 'add param type multiple literals' => ['generateMethod14.test'], 'nullable parameter inference' => ['generateMethod15.test'], 'generic parameter inference' => ['generateMethod16.test'], 'union false' => ['generateMethod17.test'], 'duplicated type guesses' => ['generateMethod_duplicateNameGuesses.test']];
    }
...
\class_alias('Phpactor202301\\Goodbye', 'Goodbye', \false);
EOT;
...
\class_alias('Phpactor202301\\Phpactor\\CodeTransform\\Tests\\Adapter\\WorseReflection\\Refactor\\WorseGenerateMethodTest', 'Phpactor\\CodeTransform\\Tests\\Adapter\\WorseReflection\\Refactor\\WorseGenerateMethodTest', \false);
