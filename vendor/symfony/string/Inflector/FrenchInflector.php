 ...
 */
namespace PhpactorDist\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'PhpactorDist\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'PhpactorDist\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'PhpactorDist\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'PhpactorDist\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'PhpactorDist\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'PhpactorDist\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
