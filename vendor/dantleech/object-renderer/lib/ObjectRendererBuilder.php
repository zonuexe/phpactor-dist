...
namespace Phpactor202301\Phpactor\ObjectRenderer;
...
final class ObjectRendererBuilder
{
    ...
    {
        $new = clone $this;
        $new->enableAncestoralCandidates = \true;
        return $new;
    }
    /**
     * Determine templates from the class of the current object and then the
    ...
    {
        $new = clone $this;
        $new->enableInterfaceCandidates = \true;
        return $new;
    }
    /**
    ...
    {
        $renderer = new TwigObjectRenderer($this->buildTwig(), $this->buildTemplateProvider());
    ...
    {
        return new Environment(new FilesystemLoader($this->templatePaths), ['autoescape' => $this->escaping, 'strict_variables' => \true]);
    }
 ...
 * A new instance of the builder is returned for each modification.
 */
\class_alias('Phpactor202301\\Phpactor\\ObjectRenderer\\ObjectRendererBuilder', 'Phpactor\\ObjectRenderer\\ObjectRendererBuilder', \false);
