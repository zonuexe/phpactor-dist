...
abstract class Node implements \JsonSerializable
{
    ...
    public function getDocCommentText()
    {
        ...
        $leadingTriviaTokens = PhpTokenizer::getTokensArrayFromContent($leadingTriviaText, ParseContext::SourceElements, $this->getFullStartPosition(), \false);
    ...
    {
        $namespaceDefinition = $this instanceof NamespaceDefinition || $this instanceof SourceFileNode ? $this : $this->getFirstAncestor(NamespaceDefinition::class, SourceFileNode::class);
