...
class QualifiedName extends Node implements NamespacedNameInterface
{
    ...
    public function getResolvedName($namespaceDefinition = null)
    {
        ...
        if ($this->parent instanceof Node\Statement\NamespaceDefinition && $this->parent->name->getStartPosition() === $this->getStartPosition() || $this->parent instanceof Node\Statement\NamespaceUseDeclaration || $this->parent instanceof Node\NamespaceUseClause || $this->parent instanceof Node\NamespaceUseGroupClause || $this->parent->parent instanceof Node\TraitUseClause || $this->parent instanceof Node\TraitSelectOrAliasClause || $this->parent instanceof TraitSelectOrAliasClause && ($this->parent->asOrInsteadOfKeyword == null || $this->parent->asOrInsteadOfKeyword->kind === TokenKind::AsKeyword)) {
            return null;
        }
