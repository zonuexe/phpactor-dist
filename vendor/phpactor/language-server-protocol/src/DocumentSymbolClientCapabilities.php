...
class DocumentSymbolClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'symbolKind' => ['names' => [], 'iterable' => \false], 'hierarchicalDocumentSymbolSupport' => ['names' => [], 'iterable' => \false], 'tagSupport' => ['names' => [], 'iterable' => \false], 'labelSupport' => ['names' => [], 'iterable' => \false]];
