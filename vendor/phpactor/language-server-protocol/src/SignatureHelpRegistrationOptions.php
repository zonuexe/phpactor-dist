...
class SignatureHelpRegistrationOptions extends TextDocumentRegistrationOptions
{
    ...
    {
        $map = ['documentSelector' => ['names' => [], 'iterable' => \false], 'triggerCharacters' => ['names' => [], 'iterable' => \true], 'retriggerCharacters' => ['names' => [], 'iterable' => \true], 'workDoneProgress' => ['names' => [], 'iterable' => \false]];
 ...
 * Mixins (implemented TS interfaces): TextDocumentRegistrationOptions, SignatureHelpOptions
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\SignatureHelpRegistrationOptions', 'Phpactor\\LanguageServerProtocol\\SignatureHelpRegistrationOptions', \false);
