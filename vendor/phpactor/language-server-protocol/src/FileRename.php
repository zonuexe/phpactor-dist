...
class FileRename
{
    ...
    {
        $map = ['oldUri' => ['names' => [], 'iterable' => \false], 'newUri' => ['names' => [], 'iterable' => \false]];
 ...
 * Represents information on a file/folder rename.
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\FileRename', 'Phpactor\\LanguageServerProtocol\\FileRename', \false);
