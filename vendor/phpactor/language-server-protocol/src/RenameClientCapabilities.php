...
class RenameClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'prepareSupport' => ['names' => [], 'iterable' => \false], 'prepareSupportDefaultBehavior' => ['names' => [], 'iterable' => \false], 'honorsChangeAnnotations' => ['names' => [], 'iterable' => \false]];
...
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\RenameClientCapabilities', 'Phpactor\\LanguageServerProtocol\\RenameClientCapabilities', \false);
