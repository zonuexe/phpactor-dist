...
class WorkDoneProgressParams
{
    ...
    {
        $map = ['workDoneToken' => ['names' => [], 'iterable' => \false]];
...
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\WorkDoneProgressParams', 'Phpactor\\LanguageServerProtocol\\WorkDoneProgressParams', \false);
