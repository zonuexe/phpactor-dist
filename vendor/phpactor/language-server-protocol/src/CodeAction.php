...
class CodeAction
{
     ...
     */
    public function __construct(string $title, ?string $kind = null, ?array $diagnostics = null, ?bool $isPreferred = null, ?array $disabled = null, ?\Phpactor\LanguageServerProtocol\WorkspaceEdit $edit = null, ?\Phpactor\LanguageServerProtocol\Command $command = null, $data = null)
    {
        $this->title = $title;
        $this->kind = $kind;
