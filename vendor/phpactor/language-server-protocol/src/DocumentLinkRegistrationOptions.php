...
class DocumentLinkRegistrationOptions extends TextDocumentRegistrationOptions
{
    ...
    {
        $map = ['documentSelector' => ['names' => [], 'iterable' => \false], 'resolveProvider' => ['names' => [], 'iterable' => \false], 'workDoneProgress' => ['names' => [], 'iterable' => \false]];
 ...
 * Mixins (implemented TS interfaces): TextDocumentRegistrationOptions, DocumentLinkOptions
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\DocumentLinkRegistrationOptions', 'Phpactor\\LanguageServerProtocol\\DocumentLinkRegistrationOptions', \false);
