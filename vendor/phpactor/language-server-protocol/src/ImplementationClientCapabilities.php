...
class ImplementationClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'linkSupport' => ['names' => [], 'iterable' => \false]];
 ...
 * Since 3.6.0
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\ImplementationClientCapabilities', 'Phpactor\\LanguageServerProtocol\\ImplementationClientCapabilities', \false);
