...
class WorkDoneProgressClientCapabilities
{
    ...
    {
        $map = ['window' => ['names' => [], 'iterable' => \false]];
...
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\WorkDoneProgressClientCapabilities', 'Phpactor\\LanguageServerProtocol\\WorkDoneProgressClientCapabilities', \false);
