...
class FormattingOptions
{
    ...
    {
        $map = ['tabSize' => ['names' => [], 'iterable' => \false], 'insertSpaces' => ['names' => [], 'iterable' => \false], 'trimTrailingWhitespace' => ['names' => [], 'iterable' => \false], 'insertFinalNewline' => ['names' => [], 'iterable' => \false], 'trimFinalNewlines' => ['names' => [], 'iterable' => \false]];
 ...
 * Value-object describing what options formatting should use.
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\FormattingOptions', 'Phpactor\\LanguageServerProtocol\\FormattingOptions', \false);
