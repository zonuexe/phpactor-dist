...
class SignatureHelpClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'signatureInformation' => ['names' => [], 'iterable' => \false], 'contextSupport' => ['names' => [], 'iterable' => \false]];
 ...
 * Client Capabilities for a [SignatureHelpRequest](#SignatureHelpRequest).
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\SignatureHelpClientCapabilities', 'Phpactor\\LanguageServerProtocol\\SignatureHelpClientCapabilities', \false);
