...
class DocumentLinkClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'tooltipSupport' => ['names' => [], 'iterable' => \false]];
 ...
 * The client capabilities of a [DocumentLinkRequest](#DocumentLinkRequest).
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\DocumentLinkClientCapabilities', 'Phpactor\\LanguageServerProtocol\\DocumentLinkClientCapabilities', \false);
