...
class CallHierarchyItem
{
     ...
     */
    public function __construct(string $name, $kind, string $uri, \Phpactor\LanguageServerProtocol\Range $range, \Phpactor\LanguageServerProtocol\Range $selectionRange, ?array $tags = null, ?string $detail = null, $data = null)
    {
        $this->name = $name;
        $this->kind = $kind;
        $this->tags = $tags;
    ...
    {
        $map = ['name' => ['names' => [], 'iterable' => \false], 'kind' => ['names' => [], 'iterable' => \false], 'tags' => ['names' => [], 'iterable' => \true], 'detail' => ['names' => [], 'iterable' => \false], 'uri' => ['names' => [], 'iterable' => \false], 'range' => ['names' => [\Phpactor\LanguageServerProtocol\Range::class], 'iterable' => \false], 'selectionRange' => ['names' => [\Phpactor\LanguageServerProtocol\Range::class], 'iterable' => \false], 'data' => ['names' => [], 'iterable' => \false]];
