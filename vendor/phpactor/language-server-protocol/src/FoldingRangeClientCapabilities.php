...
class FoldingRangeClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'rangeLimit' => ['names' => [], 'iterable' => \false], 'lineFoldingOnly' => ['names' => [], 'iterable' => \false], 'foldingRangeKind' => ['names' => [], 'iterable' => \false], 'foldingRange' => ['names' => [], 'iterable' => \false]];
