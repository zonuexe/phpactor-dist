...
class WorkspaceFoldersChangeEvent
{
    ...
    {
        $map = ['added' => ['names' => [\Phpactor\LanguageServerProtocol\WorkspaceFolder::class], 'iterable' => \true], 'removed' => ['names' => [\Phpactor\LanguageServerProtocol\WorkspaceFolder::class], 'iterable' => \true]];
