...
class WorkspaceFoldersChangeEvent
{
    ...
    {
        $map = ['added' => ['names' => [WorkspaceFolder::class], 'iterable' => \true], 'removed' => ['names' => [WorkspaceFolder::class], 'iterable' => \true]];
 ...
 * The workspace folder change event.
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\WorkspaceFoldersChangeEvent', 'Phpactor\\LanguageServerProtocol\\WorkspaceFoldersChangeEvent', \false);
