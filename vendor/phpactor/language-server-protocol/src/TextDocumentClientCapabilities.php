...
class TextDocumentClientCapabilities
{
    ...
    {
        $map = ['synchronization' => ['names' => [TextDocumentSyncClientCapabilities::class], 'iterable' => \false], 'completion' => ['names' => [CompletionClientCapabilities::class], 'iterable' => \false], 'hover' => ['names' => [HoverClientCapabilities::class], 'iterable' => \false], 'signatureHelp' => ['names' => [SignatureHelpClientCapabilities::class], 'iterable' => \false], 'declaration' => ['names' => [DeclarationClientCapabilities::class], 'iterable' => \false], 'definition' => ['names' => [DefinitionClientCapabilities::class], 'iterable' => \false], 'typeDefinition' => ['names' => [TypeDefinitionClientCapabilities::class], 'iterable' => \false], 'implementation' => ['names' => [ImplementationClientCapabilities::class], 'iterable' => \false], 'references' => ['names' => [ReferenceClientCapabilities::class], 'iterable' => \false], 'documentHighlight' => ['names' => [DocumentHighlightClientCapabilities::class], 'iterable' => \false], 'documentSymbol' => ['names' => [DocumentSymbolClientCapabilities::class], 'iterable' => \false], 'codeAction' => ['names' => [CodeActionClientCapabilities::class], 'iterable' => \false], 'codeLens' => ['names' => [CodeLensClientCapabilities::class], 'iterable' => \false], 'documentLink' => ['names' => [DocumentLinkClientCapabilities::class], 'iterable' => \false], 'colorProvider' => ['names' => [DocumentColorClientCapabilities::class], 'iterable' => \false], 'formatting' => ['names' => [DocumentFormattingClientCapabilities::class], 'iterable' => \false], 'rangeFormatting' => ['names' => [DocumentRangeFormattingClientCapabilities::class], 'iterable' => \false], 'onTypeFormatting' => ['names' => [DocumentOnTypeFormattingClientCapabilities::class], 'iterable' => \false], 'rename' => ['names' => [RenameClientCapabilities::class], 'iterable' => \false], 'foldingRange' => ['names' => [FoldingRangeClientCapabilities::class], 'iterable' => \false], 'selectionRange' => ['names' => [SelectionRangeClientCapabilities::class], 'iterable' => \false], 'publishDiagnostics' => ['names' => [PublishDiagnosticsClientCapabilities::class], 'iterable' => \false]];
 ...
 * Text document specific client capabilities.
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\TextDocumentClientCapabilities', 'Phpactor\\LanguageServerProtocol\\TextDocumentClientCapabilities', \false);
