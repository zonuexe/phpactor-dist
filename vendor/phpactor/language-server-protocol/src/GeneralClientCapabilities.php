...
class GeneralClientCapabilities
{
     ...
     */
    public function __construct(?array $staleRequestSupport = null, ?\Phpactor\LanguageServerProtocol\RegularExpressionsClientCapabilities $regularExpressions = null, ?\Phpactor\LanguageServerProtocol\MarkdownClientCapabilities $markdown = null, ?array $positionEncodings = null)
    {
    ...
    {
        $map = ['staleRequestSupport' => ['names' => [], 'iterable' => \false], 'regularExpressions' => ['names' => [\Phpactor\LanguageServerProtocol\RegularExpressionsClientCapabilities::class], 'iterable' => \false], 'markdown' => ['names' => [\Phpactor\LanguageServerProtocol\MarkdownClientCapabilities::class], 'iterable' => \false], 'positionEncodings' => ['names' => [], 'iterable' => \true]];
