...
class CompletionClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'completionItem' => ['names' => [], 'iterable' => \false], 'completionItemKind' => ['names' => [], 'iterable' => \false], 'contextSupport' => ['names' => [], 'iterable' => \false]];
