 ...
 */
class DocumentSymbolRegistrationOptions extends \Phpactor\LanguageServerProtocol\TextDocumentRegistrationOptions
{
    /**
    ...
    {
        $map = ['documentSelector' => ['names' => [], 'iterable' => \false], 'label' => ['names' => [], 'iterable' => \false], 'workDoneProgress' => ['names' => [], 'iterable' => \false]];
