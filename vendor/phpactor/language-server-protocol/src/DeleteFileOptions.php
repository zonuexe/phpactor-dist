...
class DeleteFileOptions
{
    ...
    {
        $map = ['recursive' => ['names' => [], 'iterable' => \false], 'ignoreIfNotExists' => ['names' => [], 'iterable' => \false]];
 ...
 * Delete file options
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\DeleteFileOptions', 'Phpactor\\LanguageServerProtocol\\DeleteFileOptions', \false);
