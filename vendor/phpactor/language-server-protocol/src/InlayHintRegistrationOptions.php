...
/**
 * Mixins (implemented TS interfaces): InlayHintOptions, TextDocumentRegistrationOptions, StaticRegistrationOptions
 */
class InlayHintRegistrationOptions
{
     ...
     */
    public function __construct($documentSelector = null, ?string $id = null)
    {
    ...
    {
        $map = ['documentSelector' => ['names' => [], 'iterable' => \false], 'id' => ['names' => [], 'iterable' => \false]];
