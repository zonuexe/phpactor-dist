...
class SaveOptions
{
    ...
    {
        $map = ['includeText' => ['names' => [], 'iterable' => \false]];
 ...
 * Save options.
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\SaveOptions', 'Phpactor\\LanguageServerProtocol\\SaveOptions', \false);
