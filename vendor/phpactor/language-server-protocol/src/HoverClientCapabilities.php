...
class HoverClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'contentFormat' => ['names' => [], 'iterable' => \true]];
...
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\HoverClientCapabilities', 'Phpactor\\LanguageServerProtocol\\HoverClientCapabilities', \false);
