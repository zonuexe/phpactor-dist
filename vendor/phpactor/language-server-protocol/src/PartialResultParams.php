...
class PartialResultParams
{
    ...
    {
        $map = ['partialResultToken' => ['names' => [], 'iterable' => \false]];
...
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\PartialResultParams', 'Phpactor\\LanguageServerProtocol\\PartialResultParams', \false);
