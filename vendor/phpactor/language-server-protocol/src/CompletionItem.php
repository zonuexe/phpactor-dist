...
class CompletionItem
{
     ...
     */
    public function __construct(string $label, ?\Phpactor\LanguageServerProtocol\CompletionItemLabelDetails $labelDetails = null, $kind = null, ?array $tags = null, ?string $detail = null, $documentation = null, ?bool $deprecated = null, ?bool $preselect = null, ?string $sortText = null, ?string $filterText = null, ?string $insertText = null, $insertTextFormat = null, $insertTextMode = null, $textEdit = null, ?string $textEditText = null, ?array $additionalTextEdits = null, ?array $commitCharacters = null, ?\Phpactor\LanguageServerProtocol\Command $command = null, $data = null)
    {
        $this->label = $label;
    ...
    {
        $map = ['label' => ['names' => [], 'iterable' => \false], 'labelDetails' => ['names' => [\Phpactor\LanguageServerProtocol\CompletionItemLabelDetails::class], 'iterable' => \false], 'kind' => ['names' => [], 'iterable' => \false], 'tags' => ['names' => [], 'iterable' => \true], 'detail' => ['names' => [], 'iterable' => \false], 'documentation' => ['names' => [\Phpactor\LanguageServerProtocol\MarkupContent::class], 'iterable' => \false], 'deprecated' => ['names' => [], 'iterable' => \false], 'preselect' => ['names' => [], 'iterable' => \false], 'sortText' => ['names' => [], 'iterable' => \false], 'filterText' => ['names' => [], 'iterable' => \false], 'insertText' => ['names' => [], 'iterable' => \false], 'insertTextFormat' => ['names' => [], 'iterable' => \false], 'insertTextMode' => ['names' => [], 'iterable' => \false], 'textEdit' => ['names' => [\Phpactor\LanguageServerProtocol\TextEdit::class, \Phpactor\LanguageServerProtocol\InsertReplaceEdit::class], 'iterable' => \false], 'textEditText' => ['names' => [], 'iterable' => \false], 'additionalTextEdits' => ['names' => [\Phpactor\LanguageServerProtocol\TextEdit::class], 'iterable' => \true], 'commitCharacters' => ['names' => [], 'iterable' => \true], 'command' => ['names' => [\Phpactor\LanguageServerProtocol\Command::class], 'iterable' => \false], 'data' => ['names' => [], 'iterable' => \false]];
