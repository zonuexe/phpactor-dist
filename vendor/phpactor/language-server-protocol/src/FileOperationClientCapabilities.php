...
class FileOperationClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'didCreate' => ['names' => [], 'iterable' => \false], 'willCreate' => ['names' => [], 'iterable' => \false], 'didRename' => ['names' => [], 'iterable' => \false], 'willRename' => ['names' => [], 'iterable' => \false], 'didDelete' => ['names' => [], 'iterable' => \false], 'willDelete' => ['names' => [], 'iterable' => \false]];
