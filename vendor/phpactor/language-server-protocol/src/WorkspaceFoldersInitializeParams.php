...
class WorkspaceFoldersInitializeParams
{
    ...
    {
        $map = ['workspaceFolders' => ['names' => [], 'iterable' => \false]];
...
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\WorkspaceFoldersInitializeParams', 'Phpactor\\LanguageServerProtocol\\WorkspaceFoldersInitializeParams', \false);
