...
class InlayHint
{
     ...
     */
    public function __construct(\Phpactor\LanguageServerProtocol\Position $position, $label, $kind = null, ?array $textEdits = null, $tooltip = null, ?bool $paddingLeft = null, ?bool $paddingRight = null, $data = null)
    {
    ...
    {
        $map = ['position' => ['names' => [\Phpactor\LanguageServerProtocol\Position::class], 'iterable' => \false], 'label' => ['names' => [], 'iterable' => \false], 'kind' => ['names' => [], 'iterable' => \false], 'textEdits' => ['names' => [\Phpactor\LanguageServerProtocol\TextEdit::class], 'iterable' => \true], 'tooltip' => ['names' => [\Phpactor\LanguageServerProtocol\MarkupContent::class], 'iterable' => \false], 'paddingLeft' => ['names' => [], 'iterable' => \false], 'paddingRight' => ['names' => [], 'iterable' => \false], 'data' => ['names' => [], 'iterable' => \false]];
