 ...
 */
class WorkspaceSymbol extends \Phpactor\LanguageServerProtocol\BaseSymbolInformation
{
    /**
    ...
    {
        $map = ['location' => ['names' => [\Phpactor\LanguageServerProtocol\Location::class], 'iterable' => \false], 'data' => ['names' => [], 'iterable' => \false], 'name' => ['names' => [], 'iterable' => \false], 'kind' => ['names' => [], 'iterable' => \false], 'tags' => ['names' => [], 'iterable' => \true], 'containerName' => ['names' => [], 'iterable' => \false]];
