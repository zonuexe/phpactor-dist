...
class DocumentColorRegistrationOptions extends TextDocumentRegistrationOptions
{
    ...
    {
        $map = ['documentSelector' => ['names' => [], 'iterable' => \false], 'id' => ['names' => [], 'iterable' => \false], 'workDoneProgress' => ['names' => [], 'iterable' => \false]];
 ...
 * Mixins (implemented TS interfaces): TextDocumentRegistrationOptions, StaticRegistrationOptions, DocumentColorOptions
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\DocumentColorRegistrationOptions', 'Phpactor\\LanguageServerProtocol\\DocumentColorRegistrationOptions', \false);
