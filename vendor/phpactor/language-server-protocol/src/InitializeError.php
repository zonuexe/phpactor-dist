...
class InitializeError
{
    ...
    {
        $map = ['retry' => ['names' => [], 'iterable' => \false]];
 ...
 * initialize request fails.
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\InitializeError', 'Phpactor\\LanguageServerProtocol\\InitializeError', \false);
