...
class WorkDoneProgressReport
{
    ...
    {
        $map = ['kind' => ['names' => [], 'iterable' => \false], 'cancellable' => ['names' => [], 'iterable' => \false], 'message' => ['names' => [], 'iterable' => \false], 'percentage' => ['names' => [], 'iterable' => \false]];
...
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\WorkDoneProgressReport', 'Phpactor\\LanguageServerProtocol\\WorkDoneProgressReport', \false);
