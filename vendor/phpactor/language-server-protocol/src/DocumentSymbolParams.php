 ...
 */
class DocumentSymbolParams extends WorkDoneProgressParams
{
    /**
     * The text document.
     *
    ...
    {
        $map = ['textDocument' => ['names' => [TextDocumentIdentifier::class], 'iterable' => \false], 'workDoneToken' => ['names' => [], 'iterable' => \false], 'partialResultToken' => ['names' => [], 'iterable' => \false]];
 ...
 * Mixins (implemented TS interfaces): WorkDoneProgressParams, PartialResultParams
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\DocumentSymbolParams', 'Phpactor\\LanguageServerProtocol\\DocumentSymbolParams', \false);
