...
class WorkspaceFoldersClientCapabilities
{
    ...
    {
        $map = ['workspace' => ['names' => [], 'iterable' => \false]];
...
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\WorkspaceFoldersClientCapabilities', 'Phpactor\\LanguageServerProtocol\\WorkspaceFoldersClientCapabilities', \false);
