...
class CodeActionClientCapabilities
{
    ...
    {
        $map = ['dynamicRegistration' => ['names' => [], 'iterable' => \false], 'codeActionLiteralSupport' => ['names' => [], 'iterable' => \false], 'isPreferredSupport' => ['names' => [], 'iterable' => \false], 'disabledSupport' => ['names' => [], 'iterable' => \false], 'dataSupport' => ['names' => [], 'iterable' => \false], 'resolveSupport' => ['names' => [], 'iterable' => \false], 'honorsChangeAnnotations' => ['names' => [], 'iterable' => \false]];
