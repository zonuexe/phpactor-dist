...
class CompletionRegistrationOptions extends TextDocumentRegistrationOptions
{
    ...
    {
        $map = ['documentSelector' => ['names' => [], 'iterable' => \false], 'triggerCharacters' => ['names' => [], 'iterable' => \true], 'allCommitCharacters' => ['names' => [], 'iterable' => \true], 'resolveProvider' => ['names' => [], 'iterable' => \false], 'workDoneProgress' => ['names' => [], 'iterable' => \false]];
 ...
 * Mixins (implemented TS interfaces): TextDocumentRegistrationOptions, CompletionOptions
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\CompletionRegistrationOptions', 'Phpactor\\LanguageServerProtocol\\CompletionRegistrationOptions', \false);
