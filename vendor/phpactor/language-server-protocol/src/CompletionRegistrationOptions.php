 ...
 */
class CompletionRegistrationOptions extends \Phpactor\LanguageServerProtocol\TextDocumentRegistrationOptions
{
    /**
    ...
    {
        $map = ['documentSelector' => ['names' => [], 'iterable' => \false], 'triggerCharacters' => ['names' => [], 'iterable' => \true], 'allCommitCharacters' => ['names' => [], 'iterable' => \true], 'resolveProvider' => ['names' => [], 'iterable' => \false], 'completionItem' => ['names' => [], 'iterable' => \false], 'workDoneProgress' => ['names' => [], 'iterable' => \false]];
