...
class ServerCapabilities
{
    ...
    {
        $map = ['textDocumentSync' => ['names' => [TextDocumentSyncOptions::class], 'iterable' => \false], 'completionProvider' => ['names' => [CompletionOptions::class], 'iterable' => \false], 'hoverProvider' => ['names' => [HoverOptions::class], 'iterable' => \false], 'signatureHelpProvider' => ['names' => [SignatureHelpOptions::class], 'iterable' => \false], 'declarationProvider' => ['names' => [DeclarationOptions::class, DeclarationRegistrationOptions::class], 'iterable' => \false], 'definitionProvider' => ['names' => [DefinitionOptions::class], 'iterable' => \false], 'typeDefinitionProvider' => ['names' => [TypeDefinitionOptions::class, TypeDefinitionRegistrationOptions::class], 'iterable' => \false], 'implementationProvider' => ['names' => [ImplementationOptions::class, ImplementationRegistrationOptions::class], 'iterable' => \false], 'referencesProvider' => ['names' => [ReferenceOptions::class], 'iterable' => \false], 'documentHighlightProvider' => ['names' => [DocumentHighlightOptions::class], 'iterable' => \false], 'documentSymbolProvider' => ['names' => [DocumentSymbolOptions::class], 'iterable' => \false], 'codeActionProvider' => ['names' => [CodeActionOptions::class], 'iterable' => \false], 'codeLensProvider' => ['names' => [CodeLensOptions::class], 'iterable' => \false], 'documentLinkProvider' => ['names' => [DocumentLinkOptions::class], 'iterable' => \false], 'colorProvider' => ['names' => [DocumentColorOptions::class, DocumentColorRegistrationOptions::class], 'iterable' => \false], 'workspaceSymbolProvider' => ['names' => [WorkspaceSymbolOptions::class], 'iterable' => \false], 'documentFormattingProvider' => ['names' => [DocumentFormattingOptions::class], 'iterable' => \false], 'documentRangeFormattingProvider' => ['names' => [DocumentRangeFormattingOptions::class], 'iterable' => \false], 'documentOnTypeFormattingProvider' => ['names' => [DocumentOnTypeFormattingOptions::class], 'iterable' => \false], 'renameProvider' => ['names' => [RenameOptions::class], 'iterable' => \false], 'foldingRangeProvider' => ['names' => [FoldingRangeOptions::class, FoldingRangeRegistrationOptions::class], 'iterable' => \false], 'selectionRangeProvider' => ['names' => [SelectionRangeOptions::class, SelectionRangeRegistrationOptions::class], 'iterable' => \false], 'executeCommandProvider' => ['names' => [ExecuteCommandOptions::class], 'iterable' => \false], 'experimental' => ['names' => [], 'iterable' => \false], 'workspace' => ['names' => [], 'iterable' => \false]];
 ...
 * Mixins (implemented TS interfaces): _ServerCapabilities, WorkspaceFoldersServerCapabilities
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\ServerCapabilities', 'Phpactor\\LanguageServerProtocol\\ServerCapabilities', \false);
