...
class DeleteFile extends ResourceOperation
{
    ...
    {
        $map = ['kind' => ['names' => [], 'iterable' => \false], 'uri' => ['names' => [], 'iterable' => \false], 'options' => ['names' => [DeleteFileOptions::class], 'iterable' => \false]];
 ...
 * Mixins (implemented TS interfaces): ResourceOperation
 */
\class_alias('Phpactor202301\\Phpactor\\LanguageServerProtocol\\DeleteFile', 'Phpactor\\LanguageServerProtocol\\DeleteFile', \false);
