...
// Start of ming v.
\class_alias('Phpactor202301\\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFFont', 'SWFFont', \false);
...
\class_alias('Phpactor202301\\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('Phpactor202301\\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('Phpactor202301\\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('Phpactor202301\\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('Phpactor202301\\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold
